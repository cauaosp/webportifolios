          ...
          <div className="flex flex-col gap-5 pb-10">
            ...
            <div className="flex flex-col gap-3">
              <div className="flex flex-col gap-1 mr-10">
                ...
                <div className="text-md font-light tracking-tight text-justify text-neutral-300">
            ...
            <div className="flex flex-col gap-1 mr-10">
              ...
              <div className="text-md font-light tracking-tight text-justify text text-neutral-300">
